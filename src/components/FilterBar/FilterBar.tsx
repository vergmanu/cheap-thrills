      ...
      <div className="flex flex-wrap items-center gap-3">
        {onSurprise && (
          <button
            type="button"
            onClick={onSurprise}
            className="rounded-full border border-accent-muted bg-surface px-4 py-2 text-sm font-semibold text-text-primary transition hover:-translate-y-px hover:border-accent hover:text-accent"
          >
            🎲 Surprise me
          </button>
        )}
        ...
        <button
          ...
          className="flex cursor-pointer items-center gap-2 text-sm text-text-secondary transition hover:text-text-primary"
        >
          <span className={activeOnly ? 'font-semibold text-text-primary' : ''}>Active Now</span>
          <span
            className={[
        ...
        <select
          ...
          className="rounded-full border border-border bg-surface px-4 py-2 text-sm font-semibold text-text-primary focus:border-accent focus:outline-none"
        >
